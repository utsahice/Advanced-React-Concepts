  ...
  return (
    <div className="comparison-app">
      ...
      <div className="instructions">
        ...
        <ul>
          <li><strong>Unoptimized:</strong> All components re-render on every state change</li>
          <li><strong>Optimized:</strong> Only components with changed props re-render</li>
          <li><strong>Console logs:</strong> Check browser console to see render messages</li>
          <li><strong>Performance:</strong> Notice the difference in render times</li>
        </ul>
      </div>
    </div>
  )
